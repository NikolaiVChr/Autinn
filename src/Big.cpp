...
struct Big : Module {
    ...
    Big() {
        ...
        configParam(TYPE_PARAM, 0.f, 15.f, 0.f, "Chord Type");
    ...
    void process(const ProcessArgs& args) override {
        ...
        currentType = clamp((int)typeRaw, 0, 15);
...
struct BigWidget : ModuleWidget {
    BigWidget(Big* module) {
        ...
        // Display
        BigDisplay* display = createWidget<BigDisplay>(Vec(5, 30));
        ...
        // Knobs
        addParam(createParamCentered<RoundMediumAutinnKnob>(Vec(centerX, 90), module, Big::TYPE_PARAM));
        addParam(createParamCentered<RoundMediumAutinnKnob>(Vec(centerX, 140), module, Big::SPREAD_PARAM));
        addParam(createParamCentered<RoundMediumAutinnKnob>(Vec(centerX, 190), module, Big::INV_PARAM));

        // CV
        addInput(createInputCentered<InPortAutinn>(Vec(15, 240), module, Big::TYPE_CV));
        addInput(createInputCentered<InPortAutinn>(Vec(45, 240), module, Big::SPREAD_CV));
        addInput(createInputCentered<InPortAutinn>(Vec(centerX, 280), module, Big::ROOT_INPUT));
